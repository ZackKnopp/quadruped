...
def main():
    ...
    builder.Connect(
        scene_graph.get_query_output_port(), cart_pole.get_geometry_query_input_port()
    )
    builder.Connect(
    ...
    cart_pole_context = diagram.GetMutableSubsystemContext(cart_pole, diagram_context)
